...
{
    public static class ResetPasswordOtpMessage
    {
...
<head>
  ...
  <title>Reset Your Password — Track Finder</title>
</head>
          ...
          <tr>
            <td style=""padding:40px 40px 32px;"">
              ...
              <p style=""margin:0 0 24px;color:#3f4850;font-size:16px;line-height:1.6;"">
                Hi {firstName}, we received a request to reset your Track Finder password.
                Use the code below to proceed. The code expires in <strong>{expiryMinutes} minutes</strong>.
              </p>
